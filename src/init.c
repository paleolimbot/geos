...
SEXP geos_c_version_build(void);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"geos_c_prepared_is_within_distance", (DL_FUNC)&geos_c_prepared_is_within_distance,
     3},
    ...
    {"geos_c_geos_geometry_is_null_or_xptr",
     (DL_FUNC)&geos_c_geos_geometry_is_null_or_xptr, 1},
    ...
    {"geos_c_constrained_delaunay_triangulation",
     (DL_FUNC)&geos_c_constrained_delaunay_triangulation, 1},
...
SEXP geos_c_init(void) {
  ...
  if (globalHandle == NULL) {
    ...
    GEOSContext_setErrorMessageHandler_r(globalHandle, &geos_common_handle_error,
                                         globalErrorMessage);
