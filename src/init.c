...
extern SEXP geos_c_write_wkt(SEXP input);
extern SEXP geos_c_read_wkb(SEXP input);
extern SEXP geos_c_write_wkb(SEXP input);
...
static const R_CallMethodDef CallEntries[] = {
  ...
  {"geos_c_write_wkt", (DL_FUNC) &geos_c_write_wkt, 1},
  {"geos_c_read_wkb", (DL_FUNC) &geos_c_read_wkb, 1},
  {"geos_c_write_wkb", (DL_FUNC) &geos_c_write_wkb, 1},
