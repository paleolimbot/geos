...
test_that("geo_tbl_linestring() c() and vec_c() works", {
  linestring <- geo_tbl_linestring(geo_xy(c(0, 1, 6), c(0, 2, 4)))
  ...
  expect_is(c(linestring, linestring), "geo_tbl_linestring")
  expect_length(c(linestring, linestring), 6)
  expect_is(vec_c(linestring, linestring), "geo_tbl_linestring")
  expect_length(vec_c(linestring, linestring), 6)
  expect_equal(nrow(vec_rbind(linestring_in_tbl, linestring_in_tbl)), 6)
  expect_is(vec_rbind(linestring_in_tbl, linestring_in_tbl)$linestring, "geo_tbl_linestring")
...
test_that("geo_tbl_linestring() casting works", {
  linestring <- geo_tbl_linestring(geo_xy(c(0, 1, 6), c(0, 2, 4)))
  tbl_linestring <- as_tibble(linestring)
  ...
  expect_identical(vec_cast(tbl_linestring, new_geo_tbl_linestring()), linestring)
  ...
  expect_identical(vec_cast(vec_data(tbl_linestring), new_geo_tbl_linestring()), linestring)
  expect_error(
    vec_cast(unname(vec_data(tbl_linestring)), new_geo_tbl_linestring()),
    "Can't convert an unnamed list"
  )

  expect_identical(as_geo_tbl_linestring(tbl_linestring), linestring)
  expect_identical(as_geo_tbl_linestring(df_linestring), linestring)
  expect_identical(as_geo_tbl_linestring(unclass(df_linestring)), linestring)
})


test_that("geo_tbl_multilinestring() c() and vec_c() works", {
  multilinestring <- geo_tbl_multilinestring(geo_xy(c(0, 1, 6), c(0, 2, 4)))
  ...
  expect_is(c(multilinestring, multilinestring), "geo_tbl_multilinestring")
  expect_length(c(multilinestring, multilinestring), 6)
  expect_is(vec_c(multilinestring, multilinestring), "geo_tbl_multilinestring")
...
test_that("geo_tbl_multilinestring() casting works", {
  multilinestring <- geo_tbl_multilinestring(geo_xy(c(0, 1, 6), c(0, 2, 4)))
  tbl_multilinestring <- as_tibble(multilinestring)
  ...
  expect_identical(
    vec_cast(tbl_multilinestring, new_geo_tbl_multilinestring()),
    multilinestring
  )
  ...
  expect_identical(vec_cast(vec_data(tbl_multilinestring), new_geo_tbl_multilinestring()), multilinestring)
  expect_error(
    vec_cast(unname(vec_data(tbl_multilinestring)), new_geo_tbl_multilinestring()),
    "Can't convert an unnamed list"
  )

  expect_identical(as_geo_tbl_multilinestring(tbl_multilinestring), multilinestring)
  expect_identical(as_geo_tbl_multilinestring(df_multilinestring), multilinestring)
  expect_identical(as_geo_tbl_multilinestring(unclass(df_multilinestring)), multilinestring)
})
...
test_that("linestring is can be coerced to multilinestring", {
  ...
  expect_is(c(multilinestring, linestring), "geo_tbl_multilinestring")
  expect_is(c(linestring, multilinestring), "geo_tbl_multilinestring")
  expect_is(vec_c(multilinestring, linestring), "geo_tbl_multilinestring")
  expect_is(vec_c(linestring, multilinestring), "geo_tbl_multilinestring")
})
